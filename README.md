...
* First graph shows historical cryptocurrency value by day in the last X days, where X can be choosen by user.
...
* Second graph shows historical cryptocurrency value by hour in the last X days, where X can be choosen by user.
...
* Third graph shows historical cryptocurrency value by minute in the last X days, where X can be choosen by user.
